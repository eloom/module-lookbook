...
namespace Eloom\Lookbook\Model\LookbookCategory;

use Eloom\Lookbook\Model\ResourceModel\LookbookCategory\CollectionFactory as CollectionFactory;
...
class DataProvider extends \Magento\Ui\DataProvider\AbstractDataProvider {
	...
	protected $_entityTypeCode = 'lookbook_category';
	...
	public function getData() {
		...
		$data = $this->dataPersistor->get('lookbook_category');
		if (!empty($data)) {
			$item = $this->collection->getNewEmptyItem();
			$item->setData($data);
			$this->loadedData[$item->getId()] = $item->getData();
			$this->dataPersistor->clear('lookbook_category');
		}
		return $this->loadedData;
	}

	public function getCurrentItem() {
		$item = $this->registry->registry('lookbook_lookbook_category');
		if ($item) {
			return $item;
		}
	...
	private function getImageUploader() {
		if ($this->imageUploader === null) {
			$this->imageUploader = \Magento\Framework\App\ObjectManager::getInstance()->get(
				'Eloom\Lookbook\CategoryImageUpload'
			);
		}

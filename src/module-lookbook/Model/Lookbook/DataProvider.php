...
namespace Eloom\Lookbook\Model\Lookbook;

use Eloom\Lookbook\Model\ResourceModel\Lookbook\CollectionFactory as CollectionFactory;
...
class DataProvider extends \Magento\Ui\DataProvider\AbstractDataProvider {
	...
	protected $_entityTypeCode = 'lookbook';
	...
	public function getData() {
		...
		$data = $this->dataPersistor->get('lookbook');
		if (!empty($data)) {
			$item = $this->collection->getNewEmptyItem();
			$item->setData($data);
			$this->loadedData[$item->getId()] = $item->getData();
			$this->dataPersistor->clear('lookbook');
		}
		return $this->loadedData;
	}

	public function getCurrentItem() {
		$item = $this->registry->registry('lookbook_lookbook');
		if ($item) {
			return $item;
		}

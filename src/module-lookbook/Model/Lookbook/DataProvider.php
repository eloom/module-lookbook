...
namespace Eloom\Lookbookpro\Model\Lookbook;

use Eloom\Lookbookpro\Model\ResourceModel\Lookbook\CollectionFactory as CollectionFactory;
...
class DataProvider extends \Magento\Ui\DataProvider\AbstractDataProvider {
	...
	protected $_entityTypeCode = 'eloomlookbook';
	...
	const CATEGORY_TREE_ID = 'LOOKBOOK_CATEGORY_TREE';
	...
	public function getData() {
		...
		$data = $this->dataPersistor->get('eloomlookbook');
		if (!empty($data)) {
			$item = $this->collection->getNewEmptyItem();
			$item->setData($data);
			$this->loadedData[$item->getId()] = $item->getData();
			$this->dataPersistor->clear('eloomlookbook');
		}
		return $this->loadedData;
	}

	public function getCurrentItem() {
		$item = $this->registry->registry('lookbookpro_eloomlookbook');
		if ($item) {
			return $item;
		}

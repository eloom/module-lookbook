...
class LookbookCategory extends \Eloom\Lookbookpro\Model\AbstractModel {

  const ENTITY = 'eloom_lookbook_category';

  const CACHE_TAG = 'eloom_lookbook_category';
  ...
  protected $_eventPrefix = 'eloomlookbook_category';

  protected function _construct() {
    $this->_init('Eloom\Lookbookpro\Model\ResourceModel\LookbookCategory');
  }
  ...
  public function move($parentId, $afterCategoryId) {
     ...
     */
    try {
      $parent = \Magento\Framework\App\ObjectManager::getInstance()->get('Eloom\Lookbookpro\Model\LookbookCategory')->load($parentId);

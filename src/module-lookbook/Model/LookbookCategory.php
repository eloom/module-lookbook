...
class LookbookCategory extends \Eloom\Lookbook\Model\AbstractModel {
	...
	protected function _construct() {
		$this->_init('Eloom\Lookbook\Model\ResourceModel\LookbookCategory');
	}
	...
	public function move($parentId, $afterCategoryId) {
		 ...
		 */
		try {
			$parent = \Magento\Framework\App\ObjectManager::getInstance()->get('Eloom\Lookbook\Model\LookbookCategory')->load($parentId);

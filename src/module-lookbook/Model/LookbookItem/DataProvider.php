...
namespace Eloom\Lookbook\Model\LookbookItem;

use Eloom\Lookbook\Model\ResourceModel\LookbookItem\CollectionFactory as CollectionFactory;
...
class DataProvider extends \Magento\Ui\DataProvider\AbstractDataProvider {
	...
	protected $_entityTypeCode = 'lookbook_item';
	...
	public function getData() {
		...
		$data = $this->dataPersistor->get('lookbook_item');
		if (!empty($data)) {
			$item = $this->collection->getNewEmptyItem();
			$item->setData($data);
			$this->loadedData[$item->getId()] = $item->getData();
			$this->dataPersistor->clear('lookbook_item');
		}
		return $this->loadedData;
	}

	public function getCurrentItem() {
		$item = $this->registry->registry('lookbook_lookbook_item');
		if ($item) {
			return $item;
		}

...
namespace Eloom\Lookbookpro\Model\LookbookItem;

use Eloom\Lookbookpro\Model\ResourceModel\LookbookItem\CollectionFactory as CollectionFactory;
...
class DataProvider extends \Magento\Ui\DataProvider\AbstractDataProvider {
	...
	protected $_entityTypeCode = 'eloomlookbook_item';
	...
	public function getData() {
		...
		$data = $this->dataPersistor->get('eloomlookbook_item');
		if (!empty($data)) {
			$item = $this->collection->getNewEmptyItem();
			$item->setData($data);
			$this->loadedData[$item->getId()] = $item->getData();
			$this->dataPersistor->clear('eloomlookbook_item');
		}
		return $this->loadedData;
	}

	public function getCurrentItem() {
		$item = $this->registry->registry('lookbookpro_eloomlookbook_item');
		if ($item) {
			return $item;
		}

...
class CategoryRoots implements \Magento\Framework\Option\ArrayInterface {
	...
	public function getCategoryFactory() {
		if ($this->_categoryFactory === null) {
			$this->_categoryFactory = ObjectManager::getInstance()->get('Eloom\Lookbookpro\Model\ResourceModel\LookbookCategory\CollectionFactory');
		}
	...
	protected function _getOptions() {
		...
		$collection
			...
			->addFieldToFilter('parent_id', \Eloom\Lookbookpro\Model\LookbookCategory::TREE_ROOT_ID)
			->getSelect();

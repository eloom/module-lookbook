...
namespace Eloom\Lookbook\Model\ResourceModel;
...
class Lookbook extends \Magento\Eav\Model\Entity\AbstractEntity {
	...
	public function __construct(
		...
		\Eloom\Lookbook\Model\LookbookFactory      $modelFactory,
		                                           $data = []
	) {
	...
	public function getEntityType() {
		if (empty($this->_type)) {
			$this->setType(\Eloom\Lookbook\Model\Lookbook::ENTITY);
		}
	...
	protected function _getDefaultAttributeModel() {
		return 'Eloom\Lookbook\Model\LookbookAttribute';
	}
	 ...
	 *
	 * @param \Eloom\Lookbook\Model\Lookbook $lookbook
	 * @return array
	 */
	...
	public function getLookbookItemGroupTable() {
		if (!$this->_lookbookItemGroupTable) {
			$this->_lookbookItemGroupTable = $this->getTable('lookbook_item_group');
		}
	...
	public function getLookbookCategoryTable() {
		if (!$this->_lookbookCategoryTable) {
			$this->_lookbookCategoryTable = $this->getTable('lookbook_category_lookbook');
		}

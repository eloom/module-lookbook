...
class LookbookCategory extends \Magento\Eav\Model\Entity\AbstractEntity {
  ...
  public function __construct(
    ...
    \Eloom\Lookbookpro\Model\LookbookCategoryFactory                          $modelFactory,
    \Eloom\Lookbookpro\Model\ResourceModel\LookbookCategory\CollectionFactory $categoryCollectionFactory,
                                                                                $data = []
  ) {
    $this->_storeManager = $storeManager;
    $this->_modelFactory = $modelFactory;
    $this->_categoryCollectionFactory = $categoryCollectionFactory;
    $this->connectionName = 'eloomlookbook_category';
    parent::__construct($context, $data);
  }

  protected function _construct() {
    $this->_read = 'eloomlookbook_category_read';
    $this->_write = 'eloomlookbook_category_write';
  }

  public function getEntityType() {
    if (empty($this->_type)) {
      $this->setType(\Eloom\Lookbookpro\Model\LookbookCategory::ENTITY);
    }
  ...
  protected function _getDefaultAttributeModel() {
    return 'Eloom\Lookbookpro\Model\LookbookCategoryAttribute';
  }
  ...
  protected function _getMaxPosition($path) {
    ...
    $select = $connection->select()->from(
      $this->getTable('eloom_lookbook_category_entity'),
      'MAX(' . $positionField . ')'
    )->where(
  ...
  public function changeParent(
    \Eloom\Lookbookpro\Model\LookbookCategory $category,
    \Eloom\Lookbookpro\Model\LookbookCategory $newParent,
  ...
  public function isForbiddenToDelete($categoryId) {
    if ($categoryId == \Eloom\Lookbookpro\Model\LookbookCategory::TREE_ROOT_ID) {
      return true;
    }
    ...
    foreach ($stores as $store) {
      if ($categoryId == $store->getConfig('eloom_lookbook/general/root_category')) {
        return true;
      }
    }
    return false;

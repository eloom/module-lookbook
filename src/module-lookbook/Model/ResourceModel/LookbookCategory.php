...
class LookbookCategory extends \Magento\Eav\Model\Entity\AbstractEntity {
	...
	public function __construct(
		...
		\Eloom\Lookbook\Model\LookbookCategoryFactory                          $modelFactory,
		\Eloom\Lookbook\Model\ResourceModel\LookbookCategory\CollectionFactory $categoryCollectionFactory,
		                                                                       $data = []
	) {
	...
	public function getEntityType() {
		if (empty($this->_type)) {
			$this->setType(\Eloom\Lookbook\Model\LookbookCategory::ENTITY);
		}
	...
	protected function _getDefaultAttributeModel() {
		return 'Eloom\Lookbook\Model\LookbookCategoryAttribute';
	}
	...
	public function changeParent(
		\Eloom\Lookbook\Model\LookbookCategory $category,
		\Eloom\Lookbook\Model\LookbookCategory $newParent,
	...
	public function isForbiddenToDelete($categoryId) {
		if ($categoryId == \Eloom\Lookbook\Model\LookbookCategory::TREE_ROOT_ID) {
			return true;
		}
		...
		foreach ($stores as $store) {
			if ($categoryId == $store->getConfig('lookbook/general/root_category')) {
				return true;
			}
		}
		return false;

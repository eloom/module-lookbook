...
namespace Eloom\Lookbook\Model\ResourceModel\LookbookItemAttribute;
...
class Collection extends \Magento\Eav\Model\ResourceModel\Entity\Attribute\Collection {
	...
	protected function _initSelect() {
		$this->getSelect()->from(
			...
			$this->_eavEntityFactory->create()->setType(\Eloom\Lookbook\Model\LookbookItem::ENTITY)->getTypeId()
		);
		return $this;
	}

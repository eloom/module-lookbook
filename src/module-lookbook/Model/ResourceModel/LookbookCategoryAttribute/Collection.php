<?php
namespace Eloom\Lookbookpro\Model\ResourceModel\LookbookCategoryAttribute;
...
class Collection extends \Magento\Eav\Model\ResourceModel\Entity\Attribute\Collection {
	...
	protected function _initSelect() {
		$this->getSelect()->from(
			...
			$this->_eavEntityFactory->create()->setType(\Eloom\Lookbookpro\Model\LookbookCategory::ENTITY)->getTypeId()
		);
		return $this;
	}

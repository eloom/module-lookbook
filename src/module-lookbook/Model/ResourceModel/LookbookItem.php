...
class LookbookItem extends \Magento\Eav\Model\Entity\AbstractEntity {
  ...
  public function __construct(
    ...
    \Eloom\Lookbookpro\Model\LookbookItemFactory $modelFactory,
                                                   $data = []
  ) {
  ...
  protected function _construct() {
    $this->_read = 'eloomlookbook_item_read';
    $this->_write = 'eloomlookbook_item_write';
  }

  public function getEntityType() {
    if (empty($this->_type)) {
      $this->setType(\Eloom\Lookbookpro\Model\LookbookItem::ENTITY);
    }
  ...
  protected function _getDefaultAttributeModel() {
    return 'Eloom\Lookbookpro\Model\LookbookItemAttribute';
  }
}

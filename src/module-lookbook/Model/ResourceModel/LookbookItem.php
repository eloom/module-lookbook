...
class LookbookItem extends \Magento\Eav\Model\Entity\AbstractEntity {
	...
	public function __construct(
		...
		\Eloom\Lookbook\Model\LookbookItemFactory  $modelFactory,
		                                           $data = []
	) {
	...
	public function getEntityType() {
		if (empty($this->_type)) {
			$this->setType(\Eloom\Lookbook\Model\LookbookItem::ENTITY);
		}
	...
	protected function _getDefaultAttributeModel() {
		return 'Eloom\Lookbook\Model\LookbookItemAttribute';
	}
}

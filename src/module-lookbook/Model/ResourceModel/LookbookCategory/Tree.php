...
class Tree extends Dbp {
  ...
  public function __construct(
    \Eloom\Lookbookpro\Model\ResourceModel\LookbookCategory                   $lookbookCategory,
    \Magento\Framework\App\CacheInterface                                       $cache,
    \Magento\Store\Model\StoreManagerInterface                                  $storeManager,
    \Magento\Framework\App\ResourceConnection                                   $resource,
    \Magento\Framework\Event\ManagerInterface                                   $eventManager,
    \Magento\Catalog\Model\Attribute\Config                                     $attributeConfig,
    \Eloom\Lookbookpro\Model\ResourceModel\LookbookCategory\CollectionFactory $collectionFactory
  ) {
    $this->_catalogCategory = $lookbookCategory;
    $this->_cache = $cache;
    $this->_storeManager = $storeManager;
    $this->_coreResource = $resource;
    parent::__construct(
      $resource->getConnection('eloomlookbook_category'),
      $resource->getTableName('eloom_lookbook_category_entity'),
      [
  ...
  protected function _initInactiveCategoryIds() {
    ...
    $this->_eventManager->dispatch('lookbook_category_tree_init_inactive_category_ids', ['tree' => $this]);
    return $this;
  }
  ...
  protected function _getDefaultCollection($sorted = false) {
    ...
    $attributes = $this->_attributeConfig->getAttributeNames('eloomlookbook_category');
  ...
  protected function _afterMove() {
    $this->_cache->clean([\Eloom\Lookbookpro\Model\LookbookCategory::CACHE_TAG]);
    return $this;
  }
  ...
  protected function _createCollectionDataSelect($sorted = true, $optionalAttributes = []) {
    ...
    $categoriesTable = $this->_coreResource->getTableName('eloom_lookbook_category_entity');
    $categoriesProductsTable = $this->_coreResource->getTableName('eloom_lookbook_category_lookbook');

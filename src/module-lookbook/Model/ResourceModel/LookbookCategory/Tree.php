...
class Tree extends Dbp {
	...
	public function __construct(
		\Eloom\Lookbook\Model\ResourceModel\LookbookCategory                   $lookbookCategory,
		\Magento\Framework\App\CacheInterface                                  $cache,
		\Magento\Store\Model\StoreManagerInterface                             $storeManager,
		\Magento\Framework\App\ResourceConnection                              $resource,
		\Magento\Framework\Event\ManagerInterface                              $eventManager,
		\Magento\Catalog\Model\Attribute\Config                                $attributeConfig,
		\Eloom\Lookbook\Model\ResourceModel\LookbookCategory\CollectionFactory $collectionFactory
	) {
		...
		parent::__construct(
			$resource->getConnection('lookbook_category'),
	...
	protected function _getDefaultCollection($sorted = false) {
		...
		$attributes = $this->_attributeConfig->getAttributeNames('lookbook_category');
	...
	protected function _afterMove() {
		$this->_cache->clean([\Eloom\Lookbook\Model\LookbookCategory::CACHE_TAG]);
		return $this;
	}
	...
	protected function _createCollectionDataSelect($sorted = true, $optionalAttributes = []) {
		...
		$categoriesProductsTable = $this->_coreResource->getTableName('lookbook_category_lookbook');

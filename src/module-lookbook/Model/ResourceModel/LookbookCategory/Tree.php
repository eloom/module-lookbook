...
class Tree extends Dbp {
  ...
  public function __construct(
    ...
    parent::__construct(
      ...
      $resource->getTableName('eloomlookbook_category_entity'),
      [
  ...
  protected function _createCollectionDataSelect($sorted = true, $optionalAttributes = []) {
    ...
    $categoriesTable = $this->_coreResource->getTableName('eloomlookbook_category_entity');
    $categoriesProductsTable = $this->_coreResource->getTableName('eloomlookbook_category_lookbook');

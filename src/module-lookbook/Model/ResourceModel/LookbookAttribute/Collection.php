...
namespace Eloom\Lookbookpro\Model\ResourceModel\LookbookAttribute;
...
class Collection extends \Magento\Eav\Model\ResourceModel\Entity\Attribute\Collection {
	...
	protected function _initSelect() {
		$this->getSelect()->from(
			...
			$this->_eavEntityFactory->create()->setType(\Eloom\Lookbookpro\Model\Lookbook::ENTITY)->getTypeId()
		);
		return $this;
	}

...
namespace Eloom\Lookbook\Controller;
...
class Router implements \Magento\Framework\App\RouterInterface {
	...
	public function __construct(
		...
		\Eloom\Lookbook\Model\ResourceModel\Lookbook\CollectionFactory         $lookbookCollectionFactory,
			...
			if ($urlKey[1] == 'category') {
				if (!empty($urlKey[2])) {
					...
					if ($match->count()) {
						...
						if ($category->getId() == \Eloom\Lookbook\Model\LookbookCategory::TREE_ROOT_ID) {
							return null;
						}

...
namespace Eloom\Lookbookpro\Controller;
...
class Router implements \Magento\Framework\App\RouterInterface {
  ...
  public function __construct(
    ...
    \Eloom\Lookbookpro\Model\ResourceModel\Lookbook\CollectionFactory         $lookbookCollectionFactory,
      ...
      if ($urlKey[1] == 'category') {
        if (!empty($urlKey[2])) {
          ...
          if ($match->count()) {
            ...
            if ($category->getId() == \Eloom\Lookbookpro\Model\LookbookCategory::TREE_ROOT_ID) {
              return null;
            }

...
class Edit extends AbstractLookbook {
  ...
  protected function _isAllowed() {
    return $this->_authorization->isAllowed('Eloom_Lookbookpro::eloomlookbook_edit');
  }

  protected function _initAction() {
    $resultPage = $this->resultPageFactory->create();
    $resultPage->setActiveMenu('Eloom_Lookbookpro::eloomlookbook');
    return $resultPage;
  }
  ...
  public function execute() {
    ...
    $this->_coreRegistry->register('lookbookpro_eloomlookbook', $model);

...
class AbstractLookbookCategory extends \Magento\Backend\App\Action {
	...
	protected $modelClass = 'Eloom\Lookbook\Model\LookbookCategory';
	...
	protected function _initCategory($getRootInstead = false) {
		...
		$this->_objectManager->get(\Magento\Framework\Registry::class)->register('lookbook_lookbook_category', $category);

...
class Delete extends AbstractLookbookCategory {
	protected $eventName = 'lookbook_lookbook_category_prepare_delete';
	protected $_updateMsg = 'This category was deleted.';
	protected $imageUploader = null;
	protected $filterManager = null;

	protected function _isAllowed() {
		return $this->_authorization->isAllowed('Eloom_Lookbook::lookbook_category_save');
	}
	...
	public function execute() {
		...
		if ($data) {
			...
			try {
				...
				return $resultRedirect->setPath('*/*/edit', [$this->primary => $scopeConfig->getValue('lookbook/general/root_category', 'store', $scopeCode)]);

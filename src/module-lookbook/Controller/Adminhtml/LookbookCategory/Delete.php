...
class Delete extends AbstractLookbookCategory {
  protected $eventName = 'lookbookpro_eloomlookbook_category_prepare_delete';
  protected $_updateMsg = 'This category was deleted.';
  protected $imageUploader = null;
  protected $filterManager = null;

  protected function _isAllowed() {
    return $this->_authorization->isAllowed('Eloom_Lookbookpro::eloomlookbook_category_save');
  }
  ...
  public function execute() {
    ...
    if ($data) {
      ...
      try {
        ...
        return $resultRedirect->setPath('*/*/edit', [$this->primary => $scopeConfig->getValue('eloom_lookbook/general/root_category', 'store', $scopeCode)]);

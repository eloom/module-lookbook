...
class Edit extends AbstractLookbookCategory {
  ...
  protected function _isAllowed() {
    return $this->_authorization->isAllowed('Eloom_Lookbookpro::eloomlookbook_category_edit');
  }
  ...
  public function execute() {
    ...
    if (!$id) {
      ...
      $id = $scopeConfig->getValue('eloom_lookbook/general/root_category', 'store', $scopeCode);
      if ($id) {
    ...
    $this->_coreRegistry->register('lookbookpro_eloomlookbook_category', $model);

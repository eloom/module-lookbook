...
namespace Eloom\Lookbook\Helper;
...
class Data extends \Magento\Framework\App\Helper\AbstractHelper {
	...
	public function __construct(
		...
		\Eloom\Lookbook\Model\LookbookCategoryFactory                  $categoryFactory,
		\Eloom\Lookbook\Model\LookbookFactory                          $lookbookFactory,
		\Eloom\Lookbook\Model\LookbookItemFactory                      $itemFactory,
		\Eloom\Lookbook\Helper\Image                                   $imageHelper,
	...
	public function getLoobookByCategory($category = false, $storeId = null, $recursive = false) {
		...
		$collection->getSelect()->joinLeft(
			['ccl' => $collection->getTable('lookbook_category_lookbook')],
	...
	public function getItemsByLookbookId($lookbookId, $storeId = null) {
		...
		$collection->getSelect()->joinLeft(
			['ccl' => $collection->getTable('lookbook_item_group')],
	...
	public function getCategoryThumbnailUrl($category, $width, $height = null) {
		...
		return $this->getImageUrl($path, $width, $height, 'lookbook/category');
	}
	...
	public function getLookbookThumbnailUrl($lookbook, $width, $height = null) {
		...
		return $this->getImageUrl($path, $width, $height, 'lookbook/item');
	}
	...
	public function getItemImageUrl($item, $width, $height = null) {
		...
		return $this->getImageUrl($path, $width, $height, 'lookbook/item_element');
	}
	...
	public function getColumnStyle($gridWrap, $gridItem, $generalItem, $groupId = 'lookbook/listing/lookbook_list/') {
	...
	public function getLookbookRootCategoryId() {
		return \Eloom\Lookbook\Model\LookbookCategory::TREE_ROOT_ID;
	}

	public function getStoreRootCategoryId() {
		return $this->scopeConfig->getValue('lookbook/general/root_category', 'store');
	}

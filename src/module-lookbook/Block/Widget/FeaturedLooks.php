<?php
/**
 * Copyright © 2020 Eloom, Inc. All rights reserved.
 * See COPYING.txt for license details.
 */

namespace Eloom\Lookbookpro\Block\Widget;

class FeaturedLooks extends \Eloom\Lookbookpro\Block\Item\AbstractItem implements \Magento\Widget\Block\BlockInterface {
  ...
  public function _getCollection() {
    if ($this->_lookCollection === null) {
      ...
      $this->_lookCollection = $this->_objectManager->get(\Eloom\Lookbookpro\Model\LookbookItem::class)->getCollection()->addAttributeToSelect('*');
      if ($lookIds) {
      ...
      if ($lookbookIds) {
        $this->_lookCollection->getSelect()->joinLeft(
          ['ccl' => $this->_lookCollection->getTable('eloomlookbook_item_group')],

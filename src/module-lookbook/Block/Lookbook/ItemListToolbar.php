...
namespace Eloom\Lookbook\Block\Lookbook;

use Eloom\Lookbook\Block\Item\ListItem;
use Eloom\Lookbook\Helper\ItemList;
use Eloom\Lookbook\Model\Toolbar as ToolbarModel;

class ItemListToolbar extends \Magento\Framework\View\Element\Template {
	/**
	 * Products collection
	 *
	 ...
	 * @var string
	 */
	protected $_direction = ItemList::DEFAULT_SORT_DIRECTION;
	...
	public function __construct(
		...
		$this->_itemListHelper = $ItemListHelper;
	 ...
	 * @param string $order
	 * @param string $value
	 * @return \Magento\Catalog\Block\Product\ItemList\Toolbar
	 */
	...
	public function getCurrentMode() {
		...
		$defaultMode = $this->_itemListHelper->getDefaultViewMode($this->getModes());
	...
	public function getModes() {
		if ($this->_availableMode === []) {
			$this->_availableMode = $this->_itemListHelper->getAvailableViewMode();
		}
	...
	public function getDefaultPerPageValue() {
		...
		return $this->_itemListHelper->getDefaultLimitPerPageValue($this->getCurrentMode());
	}
	...
	public function getAvailableLimit() {
		return $this->_itemListHelper->getAvailableLimit($this->getCurrentMode());
		//return ListItem::AVAILABLE_LIMIT;
	}
	...
	public function getPagerHtml() {
		$pagerBlock = $this->getChildBlock('item_list_toolbar_pager');

		if ($pagerBlock instanceof \Magento\Framework\DataObject) {
			/* @var $pagerBlock \Magento\Theme\Block\Html\Pager */
			$pagerBlock->setAvailableLimit(ListItem::AVAILABLE_LIMIT);
			$pagerBlock->setLimitVarName(ListItem::LIMIT_VAR_NAME);
	...
	public function getLimitVarName() {
		return ListItem::LIMIT_VAR_NAME;
	}
	...
	public function getWidgetOptionsJson(array $customOptions = []) {
		...
		$options = [
			...
			'limit' => ListItem::LIMIT_VAR_NAME,
			'modeDefault' => $defaultMode,
			'directionDefault' => $this->_direction ?: ItemList::DEFAULT_SORT_DIRECTION,
			'orderDefault' => $this->_itemListHelper->getDefaultSortField(),
			'limitDefault' => $this->_itemListHelper->getDefaultLimitPerPageValue($defaultMode),
	...
	protected function getOrderField() {
		if ($this->_orderField === null) {
			$this->_orderField = $this->_itemListHelper->getDefaultSortField();
		}

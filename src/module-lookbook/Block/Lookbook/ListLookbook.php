...
use Eloom\Lookbook\Block\Category\LookbookListToolbar as Toolbar;
use Eloom\Lookbook\Model\Lookbook;
use Eloom\Lookbook\Model\ResourceModel\Lookbook\Collection;
use Eloom\Lookbook\Model\Toolbar as ToolbarModel;

class ListLookbook extends \Eloom\Lookbook\Block\Lookbook\AbstractLookbook {
	...
	public function getDefaultLookbooksPerPage() {
		if (!$this->hasData('default_items_per_page')) {
			$this->setData('default_items_per_page',
				$this->_objectManager->get(\Eloom\Lookbook\Helper\LookbookList::class)

...
namespace Eloom\Lookbook\Block\Item;

use Eloom\Lookbook\Block\Lookbook\ItemListToolbar as Toolbar;
use Eloom\Lookbook\Model\LookbookItem;
use Eloom\Lookbook\Model\ResourceModel\LookbookItem\Collection;
use Eloom\Lookbook\Model\Toolbar as ToolbarModel;

class ListItem extends \Eloom\Lookbook\Block\Item\AbstractItem {
	...
	public function getDefaultItemsPerPage() {
		if (!$this->hasData('default_items_per_page')) {
			$this->setData('default_items_per_page',
				$this->_objectManager->get(\Eloom\Lookbook\Helper\ItemList::class)

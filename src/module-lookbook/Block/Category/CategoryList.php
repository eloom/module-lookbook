<?php
/**
 * Copyright © 2017 Eloom, Inc. All rights reserved.
 * See COPYING.txt for license details.
 */

namespace Eloom\Lookbook\Block\Category;
...
class CategoryList extends \Magento\Framework\View\Element\Template {
	...
	public function getMenuConfig() {
		$config = [];
		$menuType = $this->_helper->getConfig('lookbook/lookbook_category_list/display_type');
		switch ($menuType) {
			case '1' :
				$parentId = null;
				break;

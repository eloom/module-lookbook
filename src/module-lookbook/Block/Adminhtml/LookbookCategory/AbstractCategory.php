...
namespace Eloom\Lookbookpro\Block\Adminhtml\LookbookCategory;
...
class AbstractCategory extends \Magento\Backend\Block\Template {
  ...
  public function __construct(
    ...
    \Eloom\Lookbookpro\Model\ResourceModel\LookbookCategory\Tree $categoryTree,
  ...
  public function getCategory() {
    return $this->_coreRegistry->registry('lookbookpro_eloomlookbook_category');
  }
  ...
  public function getRoot($parentNodeCategory = null, $recursionLevel = 3) {
    ...
    if ($root === null) {
      ...
      if ($storeId) {
        ...
        $rootId = \Eloom\Lookbookpro\Model\LookbookCategory::TREE_ROOT_ID;
      }
      ...
      if ($root && $rootId != \Eloom\Lookbookpro\Model\LookbookCategory::TREE_ROOT_ID) {
        $root->setIsVisible(true);
      } elseif ($root && $root->getId() == \Eloom\Lookbookpro\Model\LookbookCategory::TREE_ROOT_ID) {
  ...
  public function getNode($parentNodeCategory, $recursionLevel = 2) {
    ...
    if ($node && $nodeId != \Eloom\Lookbookpro\Model\LookbookCategory::TREE_ROOT_ID) {
      $node->setIsVisible(true);
    } elseif ($node && $node->getId() == \Eloom\Lookbookpro\Model\LookbookCategory::TREE_ROOT_ID) {

...
class Tree extends \Eloom\Lookbookpro\Block\Adminhtml\LookbookCategory\AbstractCategory {
  ...
  public function getSuggestedCategoriesJson($namePart) {
    ...
    $matchingNamesCollection->addAttributeToFilter(
      ...
      'entity_id',
      ['neq' => \Eloom\Lookbookpro\Model\LookbookCategory::TREE_ROOT_ID]
    ...
    $categoryById = [
      \Eloom\Lookbookpro\Model\LookbookCategory::TREE_ROOT_ID => [
        'id' => \Eloom\Lookbookpro\Model\LookbookCategory::TREE_ROOT_ID,
        'children' => [],
      ],
    ];
    ...
    return $this->_jsonEncoder->encode($categoryById[\Eloom\Lookbookpro\Model\LookbookCategory::TREE_ROOT_ID]['children']);
  }

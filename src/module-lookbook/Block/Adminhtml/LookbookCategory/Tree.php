...
class Tree extends \Eloom\Lookbook\Block\Adminhtml\LookbookCategory\AbstractCategory {
	...
	public function getSuggestedCategoriesJson($namePart) {
		...
		$matchingNamesCollection->addAttributeToFilter(
			...
			'entity_id',
			['neq' => \Eloom\Lookbook\Model\LookbookCategory::TREE_ROOT_ID]
		...
		$categoryById = [
			\Eloom\Lookbook\Model\LookbookCategory::TREE_ROOT_ID => [
				'id' => \Eloom\Lookbook\Model\LookbookCategory::TREE_ROOT_ID,
				'children' => [],
			],
		];
		...
		return $this->_jsonEncoder->encode($categoryById[\Eloom\Lookbook\Model\LookbookCategory::TREE_ROOT_ID]['children']);
	}
